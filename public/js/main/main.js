...
async function ShowGroup() {
    try {
        ...
        <button class="list-group-item list-group-item-action py-2 text-light rounded-3" 
            data-bs-toggle="list" style="background-color:#242729; margin-left: 0px;padding-left: 5px;padding-right: 5px;margin-right: 0px;margin-bottom:5px;">
